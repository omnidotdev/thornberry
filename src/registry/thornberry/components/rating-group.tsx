...
const ratingGroupVariants = tv({
  slots: {
    ...
    control: "inline-flex",
    item: "inline-flex cursor-pointer p-1 text-base-400 outline-none data-highlighted:text-amber-500 data-checked:text-amber-500 focus-visible:ring-2 focus-visible:ring-primary",
    hiddenInput: "",
  },
});
