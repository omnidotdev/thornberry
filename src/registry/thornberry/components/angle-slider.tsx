...
const AngleSliderMarkerGroup = ({
  ...
  <ArkAngleSlider.MarkerGroup
    className={cn("absolute inset-4 rounded-full bg-white", className)}
    {...rest}
  />
);
...
const AngleSliderValueText = ({
  ...
  <ArkAngleSlider.ValueText
    className={cn(
      "pointer-events-none absolute inset-0 z-30 flex items-center justify-center text-center font-bold text-2xl",
      className,
    )}
    {...rest}
  />
