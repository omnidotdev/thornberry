---
title: Sidebar
description: A collapsible sidebar component with customizable content and responsive design.
---

import { SidebarExample } from "@/components"

<SidebarExample />

## Installation

<InstallationTabs filename="sidebar.json" />
          ...
          <SidebarMenu className="group-data-[collapsible=icon]:hidden">
            {data.navMain.map((item) => (
              <CollapsibleRoot key={item.title} defaultOpen={item.isActive}>
                ...
                <CollapsibleContent className="-mx-2 py-0 animate-none border-none">
