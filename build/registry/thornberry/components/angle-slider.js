...
"use client";
var AngleSliderRoot = ({ className, ...rest }) => /* @__PURE__ */ jsxDEV(ArkAngleSlider.Root, {
...
var AngleSliderControl = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkAngleSlider.Control, {
  className: cn("absolute inset-0 rounded-full", className),
  ...rest
}, undefined, false, undefined, this);
var AngleSliderThumb = ({ className, ...rest }) => /* @__PURE__ */ jsxDEV("div", {
  ...
  children: [
    ...
    /* @__PURE__ */ jsxDEV(ArkAngleSlider.Thumb, {
      tabIndex: -1,
...
var AngleSliderMarkerGroup = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkAngleSlider.MarkerGroup, {
...
var AngleSliderMarker = ({
  ...
  value,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkAngleSlider.Marker, {
  value,
  className,
  ...rest
}, undefined, false, undefined, this);
var AngleSliderValueText = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkAngleSlider.ValueText, {
...
var AngleSliderHiddenInput = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkAngleSlider.HiddenInput, {
  className,
  ...rest
}, undefined, false, undefined, this);
export {
