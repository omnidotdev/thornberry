...
var MenuTrigger = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.Trigger, {
  className,
  ...rest
...
var MenuPositioner = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.Positioner, {
  className,
  ...rest
}, undefined, false, undefined, this);
var MenuContent = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.Content, {
...
var MenuArrowTip = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.ArrowTip, {
...
var MenuCheckboxItem = ({
  ...
  children,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.CheckboxItem, {
...
var MenuItemGroup = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.ItemGroup, {
...
var MenuItemGroupLabel = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.ItemGroupLabel, {
...
var MenuItemText = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.ItemText, {
  className,
  ...rest
}, undefined, false, undefined, this);
var MenuItemIndicator = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.ItemIndicator, {
...
var MenuRadioItem = ({
  ...
  children,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.RadioItem, {
...
var MenuRadioItemGroup = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.RadioItemGroup, {
  className,
  ...rest
}, undefined, false, undefined, this);
var MenuSeparator = ({
  className,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.Separator, {
...
var MenuTriggerItem = ({
  ...
  children,
  ...rest
}) => /* @__PURE__ */ jsxDEV(ArkMenu.TriggerItem, {
