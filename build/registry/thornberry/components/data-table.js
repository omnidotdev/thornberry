...
function createColumn(table, columnDef, depth, parent) {
  ...
  let column = {
    ...
    getFlatColumns: memo(() => [true], () => {
      var _column$columns;
      return [column, ...(_column$columns = column.columns) == null ? undefined : _column$columns.flatMap((d) => d.getFlatColumns())];
...
var Headers = {
  createTable: (table) => {
    table.getHeaderGroups = memo(() => [table.getAllColumns(), table.getVisibleLeafColumns(), table.getState().columnPinning.left, table.getState().columnPinning.right], (allColumns, leafColumns, left, right) => {
      ...
      const leftColumns = (_left$map$filter = left == null ? undefined : left.map((columnId) => leafColumns.find((d) => d.id === columnId)).filter(Boolean)) != null ? _left$map$filter : [];
      const rightColumns = (_right$map$filter = right == null ? undefined : right.map((columnId) => leafColumns.find((d) => d.id === columnId)).filter(Boolean)) != null ? _right$map$filter : [];
    ...
    table.getLeftHeaderGroups = memo(() => [table.getAllColumns(), table.getVisibleLeafColumns(), table.getState().columnPinning.left], (allColumns, leafColumns, left) => {
      ...
      const orderedLeafColumns = (_left$map$filter2 = left == null ? undefined : left.map((columnId) => leafColumns.find((d) => d.id === columnId)).filter(Boolean)) != null ? _left$map$filter2 : [];
      return buildHeaderGroups(allColumns, orderedLeafColumns, table, "left");
    }, getMemoOptions(table.options, debug, "getLeftHeaderGroups"));
    table.getRightHeaderGroups = memo(() => [table.getAllColumns(), table.getVisibleLeafColumns(), table.getState().columnPinning.right], (allColumns, leafColumns, right) => {
      var _right$map$filter2;
      const orderedLeafColumns = (_right$map$filter2 = right == null ? undefined : right.map((columnId) => leafColumns.find((d) => d.id === columnId)).filter(Boolean)) != null ? _right$map$filter2 : [];
...
var ColumnFiltering = {
  ...
  createColumn: (column, table) => {
    ...
    column.getFilterValue = () => {
      ...
      return (_table$getState$colum = table.getState().columnFilters) == null || (_table$getState$colum = _table$getState$colum.find((d) => d.id === column.id)) == null ? undefined : _table$getState$colum.value;
    };
    column.getFilterIndex = () => {
      var _table$getState$colum2, _table$getState$colum3;
      return (_table$getState$colum2 = (_table$getState$colum3 = table.getState().columnFilters) == null ? undefined : _table$getState$colum3.findIndex((d) => d.id === column.id)) != null ? _table$getState$colum2 : -1;
    };
    column.setFilterValue = (value) => {
      table.setColumnFilters((old) => {
        const filterFn = column.getFilterFn();
        const previousFilter = old == null ? undefined : old.find((d) => d.id === column.id);
        const newFilter = functionalUpdate(value, previousFilter ? previousFilter.value : undefined);
        if (shouldAutoRemoveFilter(filterFn, newFilter, column)) {
          var _old$filter;
          return (_old$filter = old == null ? undefined : old.filter((d) => d.id !== column.id)) != null ? _old$filter : [];
        }
        const newFilterObj = {
          id: column.id,
          value: newFilter
        ...
        if (previousFilter) {
          var _old$map;
          return (_old$map = old == null ? undefined : old.map((d) => {
            if (d.id === column.id) {
              return newFilterObj;
            }
            return d;
...
var ColumnPinning = {
  ...
  createColumn: (column, table) => {
    column.pin = (position) => {
      ...
      table.setColumnPinning((old) => {
        ...
        if (position === "right") {
          ...
          return {
            left: ((_old$left = old == null ? undefined : old.left) != null ? _old$left : []).filter((d) => !(columnIds != null && columnIds.includes(d))),
            right: [...((_old$right = old == null ? undefined : old.right) != null ? _old$right : []).filter((d) => !(columnIds != null && columnIds.includes(d))), ...columnIds]
          };
        }
        if (position === "left") {
          var _old$left2, _old$right2;
          return {
            left: [...((_old$left2 = old == null ? undefined : old.left) != null ? _old$left2 : []).filter((d) => !(columnIds != null && columnIds.includes(d))), ...columnIds],
            right: ((_old$right2 = old == null ? undefined : old.right) != null ? _old$right2 : []).filter((d) => !(columnIds != null && columnIds.includes(d)))
          };
        }
        return {
          left: ((_old$left3 = old == null ? undefined : old.left) != null ? _old$left3 : []).filter((d) => !(columnIds != null && columnIds.includes(d))),
          right: ((_old$right3 = old == null ? undefined : old.right) != null ? _old$right3 : []).filter((d) => !(columnIds != null && columnIds.includes(d)))
        };
      });
    };
    column.getCanPin = () => {
    ...
    column.getIsPinned = () => {
      ...
      const isLeft = leafColumnIds.some((d) => left == null ? undefined : left.includes(d));
      const isRight = leafColumnIds.some((d) => right == null ? undefined : right.includes(d));
      ...
      return (e) => {
        ...
        const touchEvents = {
          ...
          upHandler: (e2) => {
            ...
            onEnd((_e$touches$ = e2.touches[0]) == null ? undefined : _e$touches$.clientX);
          }
        };
...
var ColumnVisibility = {
  ...
  createColumn: (column, table) => {
    ...
    column.getIsVisible = () => {
      ...
      return (_ref = childColumns.length ? childColumns.some((c) => c.getIsVisible()) : (_table$getState$colum = table.getState().columnVisibility) == null ? undefined : _table$getState$colum[column.id]) != null ? _ref : true;
    };
    column.getCanHide = () => {
      var _column$columnDef$ena, _table$options$enable;
  ...
  createTable: (table) => {
    const makeVisibleColumnsMethod = (key, getColumns) => {
      return memo(() => [getColumns(), getColumns().filter((d) => d.getIsVisible()).map((d) => d.id).join("_")], (columns) => {
        return columns.filter((d) => d.getIsVisible == null ? undefined : d.getIsVisible());
    ...
    table.getToggleAllColumnsVisibilityHandler = () => {
      return (e) => {
        var _target;
        table.toggleAllColumnsVisible((_target = e.target) == null ? undefined : _target.checked);
      };
    };
  }
};
...
var GlobalFiltering = {
  ...
  createTable: (table) => {
    ...
    table.getGlobalFilterFn = () => {
      ...
      return isFunction(globalFilterFn) ? globalFilterFn : globalFilterFn === "auto" ? table.getGlobalAutoFilterFn() : (_table$options$filter = (_table$options$filter2 = table.options.filterFns) == null ? undefined : _table$options$filter2[globalFilterFn]) != null ? _table$options$filter : filterFns[globalFilterFn];
    };
...
var RowPinning = {
  ...
  createRow: (row, table) => {
    row.pin = (position, includeLeafRows, includeParentRows) => {
      ...
      table.setRowPinning((old) => {
        ...
        if (position === "bottom") {
          ...
          return {
            top: ((_old$top = old == null ? undefined : old.top) != null ? _old$top : []).filter((d) => !(rowIds != null && rowIds.has(d))),
            bottom: [...((_old$bottom = old == null ? undefined : old.bottom) != null ? _old$bottom : []).filter((d) => !(rowIds != null && rowIds.has(d))), ...Array.from(rowIds)]
          };
        }
        if (position === "top") {
          var _old$top2, _old$bottom2;
          return {
            top: [...((_old$top2 = old == null ? undefined : old.top) != null ? _old$top2 : []).filter((d) => !(rowIds != null && rowIds.has(d))), ...Array.from(rowIds)],
            bottom: ((_old$bottom2 = old == null ? undefined : old.bottom) != null ? _old$bottom2 : []).filter((d) => !(rowIds != null && rowIds.has(d)))
          };
        }
        return {
          top: ((_old$top3 = old == null ? undefined : old.top) != null ? _old$top3 : []).filter((d) => !(rowIds != null && rowIds.has(d))),
          bottom: ((_old$bottom3 = old == null ? undefined : old.bottom) != null ? _old$bottom3 : []).filter((d) => !(rowIds != null && rowIds.has(d)))
        };
      });
    };
    row.getCanPin = () => {
    ...
    row.getIsPinned = () => {
      ...
      const isTop = rowIds.some((d) => top == null ? undefined : top.includes(d));
      const isBottom = rowIds.some((d) => bottom == null ? undefined : bottom.includes(d));
  ...
  createRow: (row, table) => {
    ...
    row.getToggleSelectedHandler = () => {
      ...
      return (e) => {
        ...
        if (!canSelect)
          return;
        row.toggleSelected((_target = e.target) == null ? undefined : _target.checked);
      };
    };
  }
};
  ...
  createColumn: (column, table) => {
    ...
    column.toggleSorting = (desc, multi) => {
      ...
      table.setSorting((old) => {
        const existingSorting = old == null ? undefined : old.find((d) => d.id === column.id);
        const existingIndex = old == null ? undefined : old.findIndex((d) => d.id === column.id);
        let newSorting = [];
        let sortAction;
    ...
    column.getIsSorted = () => {
      ...
      const columnSort = (_table$getState$sorti = table.getState().sorting) == null ? undefined : _table$getState$sorti.find((d) => d.id === column.id);
      return !columnSort ? false : columnSort.desc ? "desc" : "asc";
    };
    column.getSortIndex = () => {
      var _table$getState$sorti2, _table$getState$sorti3;
      return (_table$getState$sorti2 = (_table$getState$sorti3 = table.getState().sorting) == null ? undefined : _table$getState$sorti3.findIndex((d) => d.id === column.id)) != null ? _table$getState$sorti2 : -1;
    };
    column.clearSorting = () => {
    ...
    column.getToggleSortingHandler = () => {
      ...
      return (e) => {
        if (!canSort)
          return;
        e.persist == null || e.persist();
        column.toggleSorting == null || column.toggleSorting(undefined, column.getCanMultiSort() ? table.options.isMultiSortEvent == null ? undefined : table.options.isMultiSortEvent(e) : false);
      };
    };
  },
  createTable: (table) => {
...
function createTable(options) {
  ...
  const coreInstance = {
    ...
    _getRowId: (row, index, parent) => {
      ...
      return (_table$options$getRow = table.options.getRowId == null ? undefined : table.options.getRowId(row, index, parent)) != null ? _table$options$getRow : `${parent ? [parent.id, index].join(".") : index}`;
    },
    getCoreRowModel: () => {
  ...
  return (table) => memo(() => [table.options.data], (data) => {
    ...
    const accessRows = function(originalRows, depth, parentRow) {
      ...
      for (let i = 0;i < originalRows.length; i++) {
        const row = createRow(table, table._getRowId(originalRows[i], i, parentRow), originalRows[i], i, depth, undefined, parentRow == null ? undefined : parentRow.id);
  ...
  return (table) => memo(() => [table.getPreFilteredRowModel(), table.getState().columnFilters, table.getState().globalFilter], (rowModel, columnFilters, globalFilter) => {
    ...
    (columnFilters != null ? columnFilters : []).forEach((d) => {
      ...
      resolvedColumnFilters.push({
        id: d.id,
        filterFn,
        resolvedValue: (_filterFn$resolveFilt = filterFn.resolveFilterValue == null ? undefined : filterFn.resolveFilterValue(d.value)) != null ? _filterFn$resolveFilt : d.value
      });
    });
    ...
    if (globalFilter && globalFilterFn && globallyFilterableColumns.length) {
      ...
      globallyFilterableColumns.forEach((column) => {
        ...
        resolvedGlobalFilters.push({
          ...
          resolvedValue: (_globalFilterFn$resol = globalFilterFn.resolveFilterValue == null ? undefined : globalFilterFn.resolveFilterValue(globalFilter)) != null ? _globalFilterFn$resol : globalFilter
        });
      });
    }
...
function getSortedRowModel() {
  return (table) => memo(() => [table.getState().sorting, table.getPreSortedRowModel()], (sorting, rowModel) => {
    ...
    const availableSorting = sortingState.filter((sort) => {
      ...
      return (_table$getColumn = table.getColumn(sort.id)) == null ? undefined : _table$getColumn.getCanSort();
    });
    ...
    const sortData = (rows) => {
      ...
      sortedData.sort((rowA, rowB) => {
        for (let i = 0;i < availableSorting.length; i += 1) {
          ...
          const isDesc = (_sortEntry$desc = sortEntry == null ? undefined : sortEntry.desc) != null ? _sortEntry$desc : false;
          let sortInt = 0;
          if (sortUndefined) {
...
// src/registry/thornberry/components/data-table.tsx
import {
  ArrowDown,
  ArrowUp,
  Check,
...
var SelectionCheckbox = ({
  ...
  "aria-label": ariaLabel,
  children: [
    /* @__PURE__ */ jsxs(CheckboxControl, {
      className: "size-4 rounded-sm",
      children: [
        /* @__PURE__ */ jsx(CheckboxIndicator, {
...
var DataTable = ({
  ...
  const selectionColumn = {
    ...
    enableSorting: false,
    size: 36,
    header: ({ table: table2 }) => /* @__PURE__ */ jsx(SelectionCheckbox, {
      "aria-label": "Select all rows",
      checked: table2.getIsAllRowsSelected() ? true : table2.getIsSomeRowsSelected() ? "indeterminate" : false,
      onCheckedChange: (value) => table2.toggleAllRowsSelected(value === true)
    }),
    cell: ({ row }) => /* @__PURE__ */ jsx(SelectionCheckbox, {
  ...
  const table = useReactTable({
    ...
    enableRowSelection: enableSelection ? rowSelectable ? (row) => rowSelectable(row.original) : true : false,
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "space-y-3",
    children: [
      (searchPlaceholder || toolbar) && /* @__PURE__ */ jsxs("div", {
        className: "flex flex-wrap items-center gap-3",
        children: [
          searchPlaceholder && /* @__PURE__ */ jsxs("div", {
      ...
      enableSelection && selectedRows.length > 0 && /* @__PURE__ */ jsxs("div", {
        className: "flex flex-wrap items-center gap-3 rounded-lg border border-primary/30 bg-primary/10 px-3 py-2",
        children: [
          /* @__PURE__ */ jsxs("span", {
          ...
          /* @__PURE__ */ jsx("div", {
            ...
            children: bulkActions?.(selectedRows, clearSelection)
          }),
          /* @__PURE__ */ jsx("button", {
            type: "button",
        ...
        children: /* @__PURE__ */ jsxs(Table, {
          children: [
            ...
            /* @__PURE__ */ jsx(TableBody, {
              children: table.getRowModel().rows.length === 0 ? /* @__PURE__ */ jsx(TableRow, {
